...
const DepartmentEdit: React.FC<Props> = ({ department }) => {
  const { data, setData, put, processing, errors } = useForm({
    facility_id: department.facility_id.toString(),
    name: department.name,
    code: department.code,
    description: department.description,
    services_offered: department.services_offered,
    equipment_available: department.equipment_available,
    head_of_department: department.head_of_department ? department.head_of_department.toString() : '',
          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" disabled={processing}>Update Department</Button>
              </form>
            </CardContent>
          </Card>
        </div>
