        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-3xl font-bold tracking-tight">Edit Facility: {facility.name}</h1>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <Input 
                                        ...
                                        onChange={e => setData('capacity', { ...data.capacity, total_beds: parseInt(e.target.value) || 0 })} 
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <Input 
                                        ...
                                        onChange={e => setData('capacity', { ...data.capacity, icu_beds: parseInt(e.target.value) || 0 })} 
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <Input 
                                        ...
                                        onChange={e => setData('capacity', { ...data.capacity, emergency_beds: parseInt(e.target.value) || 0 })} 
                                    />
                                </div>
                            </div>
