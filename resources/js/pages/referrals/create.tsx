...
export default function ReferralCreate({ auth }: PageProps) {
    ...
    <AppLayout breadcrumbs={breadcrumbs} user={auth.user}>
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="cs_white_bg cs_radius_25 cs_shadow_1">
            <div className="p-8 border-b border-[#307BC4]/10">
              <h1 className="cs_fs_32 cs_primary_font cs_bold cs_heading_color">Create New Referral</h1>
            </div>
            <div className="p-8">
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <TabsContent value="basic">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Select value={data.referring_facility_id} onValueChange={(value) => setData('referring_facility_id', value)}>
                          <SelectTrigger>
                      ...
                      <div>
                        ...
                        <Select value={data.receiving_facility_id} onValueChange={(value) => setData('receiving_facility_id', value)}>
                          <SelectTrigger>
                            <SelectValue placeholder="Select facility" />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div>
                        ...
                        <Select value={data.specialty_id} onValueChange={(value) => setData('specialty_id', value)}>
                          <SelectTrigger>
                ...
                <Button type="submit" disabled={processing}>Create Referral</Button>
              </form>
            </div>
          </div>
        </div>
